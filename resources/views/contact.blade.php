...
<body>
	...
	<div class="header_section">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="about">VIDEO</a>
                </li>
               <li class="nav-item">
                ...
                <li class="nav-item">
                                <button style="margin-left:5px;height:40px;" class="btn btn-outline-success"
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="posts">USER</a>
                </li>
              </ul>
            </div>
        </nav>
          ...
          <div class="email_box">
                    <div class="input_main">
                       <div class="container">
                        ...
                        <div class="main_bt"><a href="posts">SEND</a></div>                  
                    </div>
                 </div>
        </div>
        <div class="col-md-6">
          <div class="image_6"><img src="Brand/siuuu.png"></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="copyright_section">
    <div class="container">
      <p class="copyright_text">Copyright 2020 All Right Reserved By <a href="https://html.design/">Razzy Rexza</p>
    </div>
  </div>
